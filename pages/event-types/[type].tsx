        ...
        heading={
          <div className="relative group" onClick={() => setEditIcon(false)}>
            <input
              ...
              id="title"
              required
              className="w-full pl-0 text-xl font-bold text-gray-500 bg-transparent border-none cursor-pointer focus:text-blue-600 hover:text-gray-700 focus:ring-0 focus:outline-none"
