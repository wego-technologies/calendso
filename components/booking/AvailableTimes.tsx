          ...
          return (
            <div key={slot.time.format()}>
              <Link href={bookingUrl}>
                <a className="block py-4 mb-4 font-medium bg-white border rounded-lg border-neutral-300 dark:bg-gray-600 text-primary-500 dark:text-neutral-200 dark:border-transparent hover:text-white hover:bg-blue-600 dark:hover:border-black dark:hover:bg-black">
