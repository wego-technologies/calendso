                ...
                <Link href={bookingUrl}>
                  <a
                    className={classNames(
                      "block py-4 mb-2 font-medium bg-white border rounded-lg dark:bg-gray-600 text-primary-500 dark:text-neutral-200 dark:border-transparent hover:text-white hover:bg-brand hover:text-brandcontrast dark:hover:border-black dark:hover:bg-brand dark:hover:text-brandcontrast",
